    ...
    Mutation: {
        createPost: (_, { input }, context) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                ...
                yield (0, isLoggedIn_1.isLoggedIn)(context.req, context.res, context.next);
                // If isLoggedIn doesn't throw an error, proceed with creating the post
        ...
        updatePost: (_, { postId, input }, context) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                // Check authentication
                yield (0, isLoggedIn_1.isLoggedIn)(context.req, context.res, context.next);
                // If isLoggedIn doesn't throw an error, proceed with updating the post
        ...
        deletePost: (_, { postId }, context) => __awaiter(void 0, void 0, void 0, function* () {
            try {
                // Check authentication
                yield (0, isLoggedIn_1.isLoggedIn)(context.req, context.res, context.next);
                // If isLoggedIn doesn't throw an error, proceed with deleting the post
